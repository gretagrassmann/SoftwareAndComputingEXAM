...
def node_average_model(input, params, filters=None, dropout_keep_prob=1.0, trainable=True):
    ...
    #the activation function is now a tanh function
...
#the classification has to be performed on an average of the results for the ligand-receptor and receptor-ligan pairs
